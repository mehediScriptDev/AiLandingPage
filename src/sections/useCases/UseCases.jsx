...
const UseCases = () => {
  return (
    <section id="use-cases" className="py-8 lg:py-20 relative">
      ...
      <div className="max-w-7xl w-11/12 mx-auto">
        ...
        {/* Use Case Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 mb-6 lg:mb-12">
          {useCases.map((useCase, index) => {
            const Icon = useCase.icon;
            return (
              <div
                key={index}
                className="bg-linear-to-br from-white/5 to-white/2 backdrop-blur-sm border border-white/10 rounded-xl p-6 lg:p-8 hover:border-primary/50 transition-all duration-300 group"
              >
